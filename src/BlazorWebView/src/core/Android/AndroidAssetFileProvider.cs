...
namespace Microsoft.AspNetCore.Components.WebView.Maui
{
	...
	/// </summary>
	internal sealed class AndroidAssetFileProvider : IFileProvider, IDisposable
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="AndroidAssetFileProvider"/> class.
		/// </summary>
		...
		public AndroidAssetFileProvider(AssetManager assetManager, string contentRoot)
		{
			...
			{
				throw new InvalidOperationException("The Android assets could not be extracted into the expected location.");
			}
